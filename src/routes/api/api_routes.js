...
import sidebar_cont from "../../controllers/api/sidebar_controller";
import password_cont from "../../controllers/api/password_controller";
import info_cont from "../../controllers/api/informasi_controller";
import grup_cont from "../../controllers/api/grup_controller";
import main_cont from "../../controllers/global/main_controller";
...
import {
  ...
  check_register_user,
  check_update_user,
  check_update_periode,
  check_save_satuan,
  check_update_satuan,
  check_save_kategori,
  check_update_kategori,
  check_save_barang,
  check_update_barang,
  check_save_otority,
  check_save_order,
  ...
  check_update_sales,
  check_cancel_sales,
  check_save_barang_rusak,
  check_update_barang_rusak,
  check_cancel_barang_rusak,
  check_save_repack_barang,
  check_update_repack_barang,
  check_cancel_repack_barang,
...
export default Router()
  ...
  .put("/password", is_login, check_password, password_cont.update)
  .get("/info", is_login, info_cont.index)
  .post("/info", is_login, check_info, info_cont.save)
  ...
  .post("/barang-rusak/approve", is_login, check_save_barang_rusak, barang_rusak_cont.approve)
  ...
  .delete("/barang-rusak/reject", is_login, check_cancel_barang_rusak, barang_rusak_cont.reject)
