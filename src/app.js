...
const { PREFIX_ROUTE, APP_PORT, APP_NAME, APP_URL, APP_FRONTEND_URL, APP_FRONTEND_IP_URL, APP_FRONTEND_IP_URL_NO_PORT, APP_FRONTEND_URL_NO_PORT } = process.env;
const app = express();
...
const io = new Server(http, {
  cors: {
    origin: [APP_FRONTEND_URL, APP_FRONTEND_IP_URL, APP_FRONTEND_IP_URL_NO_PORT, APP_FRONTEND_URL_NO_PORT],
    methods: ["GET", "POST"],
    credentials: true,
  },
});
